...
module.exports = {
  ...
  ...defineScene("return_to_hub", () => [
    action("hub_cell", [cond.playerAt("cell")]),
    action("hub_yard", [cond.playerAt("yard")]),
    action("hub_cafeteria", [cond.playerAt("cafeteria")]),
    action("hub_workshop", [cond.playerAt("workshop")]),
